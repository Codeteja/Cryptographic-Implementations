...
void Inv_subbytes(unsigned char* state)
{
    ...
    //printf("\n After Inverse-Byte susbstitution \n");
...
void Inv_shifrows(unsigned char* state)
{
...
void keyexpansion(unsigned char* inputkey , unsigned char* expandedkey)
{
 ...
 /*printf("\n expandedkey of total 176 bytes \n");
    for(int i=0 ; i<11 ; i++)
    {
...
void aes_decrypt(unsigned char* input , unsigned char* inputkey , unsigned char* plaintext)
{
...
int main() {
    // Define your plaintext message (replace with your message)
...
unsigned char plaintext[16];
    ...
    // Calculate the length of the plaintext message
    uint64_t ciphertext_len = strlen((char *)ciphertext);
    ...
    uint64_t padding_len = block_size - (ciphertext_len % block_size);
    ...
    // Now, the "block_message" buffer contains the padded block.
    // You can use it for encryption or other purposes.
   /* printf("Padded block message: ");
    ...
    for(int i=0 ; i< ciphertext_len/16 ; i++)
    {
        for(int j=0 ; j<16 ; j++)
        {
            arr[j] = ciphertext[16*i + j];
        }
        
        printf("\n");
        printf("%d block of ciphertext is ", i+1);
        printf("\n");
        ...
        aes_decrypt(arr,key,plaintext);
        
        for(int i=0 ; i<16 ; i++)
        {
            new_arr[i] = plaintext[i];
        }
        
        printf("\n");
        printf("IV used in this round is ");
        printf("\n");
        ...
        printf("\n");
        XOR(IV , new_arr , round_iv);
        
        printf("After XOR with iv the decryption is\n");
        
        //printf("Decryption of the block is");
        //printf("\n");
    
        
        for(int k=0 ; k < 16 ; k++)
        {
            printf(" %02X ", round_iv[k]);
