...
void aes_encrypt(unsigned char* input , unsigned char* inputkey , unsigned char* ciphertext)
{
...
unsigned char ciphertext[16];
    ...
    uint64_t plaintext_len = strlen((char *)plaintext);
   ...
   /* printf("Padded block message: ");
    ...
    for(int i=0 ; i< plaintext_len/16 ; i++)
    {
        for(int j=0 ; j<16 ; j++)
        {
            arr[j] = plaintext[16*i + j];
        }
        
        printf("\n");
        printf("%d block of plaintext is ", i+1);
        printf("\n");
        ...
        aes_encrypt(round_iv , key , ciphertext);
